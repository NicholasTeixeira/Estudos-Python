...
def armazenar_dados():
    caminho_do_arquivo = os.path.join("D:/PythonPratice/myfristproject/Facul/Algoritimo Python/Forum_de_Algoritimos_e_lógica_de_Programação/dados", "dados_da_pesquisa.txt")
